            ...
            <div class="card">
              <div class="card-body">
                <form class="form-signin" data-testid="form-employee">
                  ...
                  <button class="btn btn-lg btn-primary btn-block" data-testid="employee-login-button" id="test_preventDefault" style="background-color: #0E5AE5;" type="submit">Se connecter</button>
                </form>
              </div>
            </div>
          </div>
